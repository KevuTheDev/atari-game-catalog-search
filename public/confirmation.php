...
<head>
    ...
    <title>Confirmation | Atari Game Search</title>
...
if (isset($_SESSION["username"]) == true) {
    ...
    if (empty($_SESSION["form_type"]) == false && empty($_SESSION["confirmation"]) == false) {
        ...
        if ($_SESSION["confirmation"] == "valid") {
            if ($_SESSION["form_type"] == "add_developer") {
                print "<p>Welcome " . $_SESSION["new_user"] . ", you can now add games into the catalog!!</p>";
